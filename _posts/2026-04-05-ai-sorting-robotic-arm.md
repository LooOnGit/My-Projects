...
image:
  path: /assets/img/projects/arm_robot/image49.png
---
...
![System Architecture](/assets/img/projects/arm_robot/image41.png)
...
- Commands follow a strict positioning format (like `#1P1500...T500D500`) to articulate the 5-DOF robotic arm, commanding it to grip the object and deposit it into the corresponding target.

![Real Robotic Model](/assets/img/projects/arm_robot/image49.png)
...
![IoT Dashboard Node-RED](/assets/img/projects/arm_robot/image44.png)

### 4. Hardware Enclosure (`box` Branch)
- Additional workflows like physical packaging, including perfectly fitting 3D-printed enclosure designs, are preserved in supplementary branches like `box` to keep the electronics and controllers securely housed.

![Hardware Enclosure Box](/assets/img/projects/arm_robot/image55.png)
